...
- You can also note which jobs have employees that are paid way above the normal pay and there are many jobs where all employees are within the IQR and display no outliers at all. 
